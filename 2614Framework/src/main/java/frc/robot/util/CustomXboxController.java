...
public class CustomXboxController extends XboxController{
    ...
    public edu.wpi.first.wpilibj2.command.button.Button getLeftTriggerObject(){
        return new edu.wpi.first.wpilibj2.command.button.Button( () -> super.getLeftTriggerAxis() >= Constants.CustomXboxController.kTriggerThreshold);
    }
    public edu.wpi.first.wpilibj2.command.button.Button getRightTriggerObject(){
        return new edu.wpi.first.wpilibj2.command.button.Button( () -> super.getRightTriggerAxis() >= Constants.CustomXboxController.kTriggerThreshold);
    }
    public edu.wpi.first.wpilibj2.command.button.Button getLeftXJoystickObject(){
        return new edu.wpi.first.wpilibj2.command.button.Button(() -> super.getLeftX() >= Constants.CustomXboxController.kTriggerThreshold);
    }
    public edu.wpi.first.wpilibj2.command.button.Button getLeftYJoystickObject(){
        return new edu.wpi.first.wpilibj2.command.button.Button(() -> super.getLeftY() >= Constants.CustomXboxController.kTriggerThreshold);
    }
    public edu.wpi.first.wpilibj2.command.button.Button getRightXJoystickObject(){
        return new edu.wpi.first.wpilibj2.command.button.Button(() -> super.getRightX() >= Constants.CustomXboxController.kTriggerThreshold);
    }
    public edu.wpi.first.wpilibj2.command.button.Button getRightYJoystickObject(){
        return new edu.wpi.first.wpilibj2.command.button.Button(() -> super.getRightY() >= Constants.CustomXboxController.kTriggerThreshold);
    }
}
